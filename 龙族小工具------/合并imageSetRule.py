...
#测试用路径
new_path = r"C:\Users\gwx-pc\Desktop\zzz\imageSetRule1.json"
old_path = r"C:\Users\gwx-pc\Desktop\zzz\imageSetRule.json"
...
load_old_dict.update(load_new_dict)
print(load_old_dict[rule_graphics])
